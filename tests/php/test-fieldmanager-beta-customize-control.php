<?php
class Test_Fieldmanager_Beta_Customize_Control extends Fieldmanager_Beta_Customize_UnitTestCase {
	protected $mock_context;

	function setUp() {
		parent::setUp();

		$this->mock_context = $this->getMockBuilder( 'Fieldmanager_Beta_Context_Customize' )
	...
	function test_parent_construction() {
		...
		$actual = new Fieldmanager_Beta_Customize_Control( $this->manager, 'foo', array(
	...
	function test_invalid_construction() {
		new Fieldmanager_Beta_Customize_Control( $this->manager, 'foo', array() );
	}

	function test_type() {
		$control = new Fieldmanager_Beta_Customize_Control( $this->manager, rand_str(), array( 'context' => $this->mock_context ) );
		$this->assertSame( 'fieldmanager-beta', $control->type );
	}
	...
	function test_render_content() {
		...
		$context = new Fieldmanager_Beta_Context_Customize( array(
