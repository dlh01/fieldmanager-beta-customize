<?php
class Test_Fieldmanager_Beta_Context_Customize extends Fieldmanager_Beta_Customize_UnitTestCase {
	protected $field;
	protected $old_debug;
	...
	function test_section_title() {
		...
		new Fieldmanager_Beta_Context_Customize( array( 'section_args' => array( 'title' => $title ) ), $this->field );
		$this->register();
	...
	function test_section_args() {
		...
		new Fieldmanager_Beta_Context_Customize( array(
			'section_args' => array(
				'title' => $title,
				'priority' => $priority,
			),
	...
	function test_bare_setting() {
		new Fieldmanager_Beta_Context_Customize( 'Foo', $this->field );
		$this->register();
		$this->assertInstanceOf( 'Fieldmanager_Beta_Customize_Setting', $this->manager->get_setting( $this->field->name ) );
	}
	...
	function test_bare_control() {
		...
		$this->assertInstanceOf( 'Fieldmanager_Beta_Customize_Control', $actual );
		$this->assertSame( $this->field->name, $actual->section );
		$this->assertInstanceOf( 'Fieldmanager_Beta_Customize_Setting', $actual->settings['default'] );
	}
	...
	function test_validate_valid_value() {
		...
		$context = new Fieldmanager_Beta_Context_Customize( 'Foo', $this->field );
		$this->register();
		$setting = $this->manager->get_setting( $this->field->name );
	...
	function test_validate_invalid_value( $debug ) {
		...
		$message = ( $debug ) ? __( 'Failed with $debug = true', 'fieldmanager-beta-customize' ) : __( 'Failed with $debug = false', 'fieldmanager-beta-customize' );
...
',
		...
		$context = new Fieldmanager_Beta_Context_Customize( 'Foo', $fm );
		$this->register();
	...
	function test_render_field() {
		...
		$context = new Fieldmanager_Beta_Context_Customize( 'Foo', $field );
