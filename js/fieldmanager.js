...
$( document ).ready( function () {
	...
	$( document ).on( 'fm_activate_tab fm_beta_customize_control_section_expanded', init_sortable );
	$( document ).on( 'fm_beta_customize_control_section_expanded', init_label_macros );
