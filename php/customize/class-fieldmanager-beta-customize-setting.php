<?php
/**
 * Class file for Fieldmanager_Beta_Customize_Setting.
 *
...
if ( class_exists( 'WP_Customize_Setting' ) ) :
	 ...
	 */
	class Fieldmanager_Beta_Customize_Setting extends WP_Customize_Setting {
		/**
		 * The Fieldmanager context controlling this setting.
		 *
		 * @var Fieldmanager_Beta_Context_Customize
		 */
		protected $context;
		...
		public function __construct( $manager, $id, $args = array() ) {
			if ( isset( $args['context'] ) && ( $args['context'] instanceof Fieldmanager_Beta_Context_Customize ) ) {
				...
				throw new FM_Developer_Exception( __( 'Fieldmanager_Beta_Customize_Setting requires a Fieldmanager_Beta_Context_Customize', 'fieldmanager-beta-customize' ) );
			}
		...
		public function _preview_filter( $original ) {
			 ...
			 * hooks to those methods in Fieldmanager_Beta_Context_Customize, which
