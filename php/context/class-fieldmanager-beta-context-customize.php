<?php
/**
 * Class file for Fieldmanager_Beta_Context_Customize.
 *
 ...
 */
class Fieldmanager_Beta_Context_Customize extends Fieldmanager_Context {
	/**
	 ...
	 * Constructor.
	 *
	 * @param array              $args Customizer object arguments. @see Fieldmanager_Beta_Context_Customize::args.
	 ...
	 *
	 * @param  WP_Customize_Manager $manager WP_Customize_Manager instance.
	 * @return Fieldmanager_Beta_Customize_Setting Setting object, where supported.
	 */
	protected function register_setting( $manager ) {
		return $manager->add_setting(
			new Fieldmanager_Beta_Customize_Setting( $manager, $this->fm->name, wp_parse_args(
	 ...
	 *
	 * @param  WP_Customize_Manager $manager WP_Customize_Manager instance.
	 * @return Fieldmanager_Beta_Customize_Control Control object, where supported.
	 */
	protected function register_control( $manager ) {
		return $manager->add_control(
			new Fieldmanager_Beta_Customize_Control( $manager, $this->fm->name, wp_parse_args(
